<template xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
  <v-container fluid grid-list-md >
    <v-layout row wrap >
      ...
      <img                     src="../../assets2/按钮一阶系统串级1.png"                          style="position: absolute; left: 1%;top: 30%;" onclick="location='/#/form/one-cascade-form3'"/>
...
<!--
      <img src="../../assets2/水箱图一.png" style="position: absolute;left: 22%;top: 14%;"/>
-->
      ...
      <!--<img src="../../assets2/水箱1.gif" style="position: absolute;left: 22%;top: 14%;"/>-->
      ...
      <img src="../../assets2/框图2底框.png" style="position: absolute;left: 3%;top:60%;"/>
      <img src="../../assets2/框图2.png" style="position: absolute;left: 4%;top:68%;"/>


<!--      <img src="../../assets2/输入框k1.png" style="position: absolute;left: 67.5%;top:48%"/>
      <img src="../../assets2/输入框a1.png" style="position: absolute;left: 81.5%;top:48%"/>-->
      <img src="../../assets2/公式1+tao.png" style="position: absolute;left: 69%;top: 57%;"/>
...
<!--
            ...
            <v-container>
              ...
              <v-layout>
                <v-flex v-if="signal == 1" style="position:relative;">
                      ...
                      <v-text-field placeholder="阶跃扰动值" label="阶跃扰动值" v-model="disturbValue" style="width: 120px;" clearable></v-text-field>
                </v-flex>
      ...
      <v-btn @click="dialog2 = true" style="background:	#FF8C00;z-index: 9" class="disturb">请输入干扰</v-btn>
  ...
  export default {
    ...
    methods: {
      ...
      showData(resp){
        ...
        this.option.series[0].data=resp[1];
