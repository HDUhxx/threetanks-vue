<template xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
  <v-container fluid grid-list-md >
    <v-layout row wrap >
      ...
      <img  src="../../assets2/按钮前馈控制点击.png"    style="position: absolute; left: 3%;top: 47%;" onclick="location='/#/form/TwoPreForm2'"/>
      ...
      <img  src="../../assets2/一阶有干扰.png" style="position: absolute;left: 62%;top: 8%;"/>

      <img src="../../assets2/框图加1.png" style="position: absolute;left: 15%;top:60%;"/>
      ...
      <img v-if="singnalchuang == 1" v-on:mouseenter="changechuang1" @click="modelSub" src="../../assets2/按钮创建模型.png" style="position: absolute;left: 85%;top:70%;"/>
      <img v-if="singnalchuang == 2" v-on:mouseleave="changechuang2" @click="modelSub" src="../../assets2/按钮创建模型点击.png" style="position: absolute;left:85%;top:70%;"/>
      ...
      <v-flex style="position: absolute;left: 68%;top:83.5%;width: 100px;">
        <v-col cols="12" sm="6" md="3" >
          <!--
                    <h2 style="color: white;font-size: 150%;">Kp:</h2>
          -->
          <el-input v-model="kp0" placeholder="kp0" label="kp0" class="te"></el-input>
        </v-col>
      </v-flex>
      ...
      <v-flex style="position: absolute;left: 82.5%;top:83.5%;width: 120px;">
        <v-col cols="12" sm="6" md="3" >
          ...
          -->
          <el-input v-model="kd1" placeholder="kd1" label="kd1" class="te"></el-input>
        </v-col>
      </v-flex>
