  ...
  <v-layout>
    <v-flex style="width: 50%">
      <v-layout style="height: 30%">
        <v-container>
          <v-card>
            <v-card-title><h2>双容水箱液位控制系统</h2></v-card-title>
            <v-card-text>
              <img style="display:block;margin:0 auto;height: 150px;width: 200px" src="../../assets/doubleLevel.png">
            </v-card-text>
          </v-card>
        </v-container>
      </v-layout>
      <v-layout style="height: 35%">
        <v-container>
          <v-card>
            ...
            <v-card-text>
              <img style="display:block;margin:0 auto;height: 400px;width: 700px" src="../../assets/前馈串级控制结构图.png">
            </v-card-text>
          </v-card>
        </v-container>
      </v-layout>
        ...
        <v-container>
          <v-card>
            ...
            <v-card-text class="px2">
              <div ref="chartOne" style="width: 700px;height:450px"></div>
            </v-card-text>
          </v-card>
        </v-container>
      </v-layout>
